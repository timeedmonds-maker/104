...
OUT = ROOT / "remaining_overlap_event_chains_v11.json"
...
def main() -> int:
    ...
    for key in keys:
        ...
        cases.append({
            ...
            "events": [{
                k: e.get(k) for k in (
                    "exact_date", "event_type", "source_team_id", "destination_team_id", "source_team_name",
                    "destination_team_name", "source_system", "source_reference", "raw_text", "confidence",
                    "identity_resolution", "team_resolution", "derived_boundary_type", "derived_from_signing_date"
                )
            } for e in ev],
        })
