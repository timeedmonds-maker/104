...
def main() -> int:
    ...
    nba_view_cols=pick_columns(nba,["GAME_ID","EVENTNUM","EVENTMSGTYPE","EVENTMSGACTIONTYPE","PERIOD","PCTIMESTRING","PLAYER1_ID","PLAYER1_NAME","PLAYER1_TEAM_ID","PLAYER2_ID","PLAYER2_NAME","PLAYER2_TEAM_ID","PLAYER3_ID","PLAYER3_NAME","PLAYER3_TEAM_ID","HOMEDESCRIPTION","VISITORDESCRIPTION","NEUTRALDESCRIPTION"])
    ...
    for game_id, period, team_id, candidates in CASES:
        ...
        # All v3 rows whose primary person is one of the six candidates.
        ...
        # Legacy NBA substitution rows involving any candidate, including PLAYER2.
