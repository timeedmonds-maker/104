...
urls=['https://aws.basketball-reference.com/players/a/adamsst01/on-off/2025','https://www.basketball-reference.com/players/a/adamsst01/on-off/2025']
...
for url in urls:
    try:
        ...
        if r.ok and 'On Court' in r.text:
            ...
            break
    except Exception as e: results.append({'url':url,'error':repr(e)})
